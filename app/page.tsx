...
const basePath = '/cnno-1775460054508';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Indulge in our classic cinnamon rolls, made with love and care to bring you a taste of warmth and comfort. Our OG Rolls are a timeless treat that will leave you wanting more.', i: 'https://images.unsplash.com/photo-1517433670165-51e2c0e8e72c?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'Experience the unique flavor of our pistachio rolls, carefully crafted to provide a delightful twist on our classic recipe. Perfect for those looking to try something new and exciting.', i: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Satisfy your sweet tooth with our rich and decadent chocolate rolls. Made with high-quality chocolate and a touch of love, these rolls are sure to become a favorite.', i: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc7a?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Our baby rolls are the perfect snack for any time of day. Soft, fluffy, and full of flavor, these bite-sized treats are sure to bring a smile to your face.', i: 'https://images.unsplash.com/photo-1578985545062-a3b02dc3e4e1?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'Gather your friends and family and indulge in our party box, filled with an assortment of our delicious rolls. Perfect for any occasion, our party box is sure to be a hit.', i: 'https://images.unsplash.com/photo-1568254183919-78a4f43a2877?w=1200&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1565559079314-0f544a3f8cb8?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional cinnamon rolls that bring warmth, comfort, and joy to our customers, while fostering a culture of quality, creativity, and community.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1200&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1574085733277-851d9d856a3a?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
